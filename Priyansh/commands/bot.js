...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "Kamina") || (event.body.toLowerCase() == "sala")) {
       return api.sendMessage("𝐆𝐀𝐋𝐢 𝐍𝐀 𝐃𝐄 𝐒𝐀𝐌𝐄𝐄𝐑 𝐁𝐀𝐁𝐔 𝐊𝐎 𝐁𝐀𝐓𝐀 𝐃𝐔𝐍𝐆𝐢 🙄🙄🙏", threadID);
     };
   ...
   if ((event.body.toLowerCase() == "funny") || (event.body.toLowerCase() == "songs")) {
    ...
    if ((event.body.toLowerCase() == "i hate you") || (event.body.toLowerCase() == "hate you")) {
     ...
     if ((event.body.toLowerCase() == "😏") || (event.body.toLowerCase() == "😏")) {
       return api.sendMessage("😻🌿𝐓𝐄𝐑𝐈 𝐓𝐎𝐅𝐅𝐈 𝐋𝐄𝐋𝐢 𝐊𝐢𝐒𝐢𝐍𝐄 𝐉𝐎 𝐀𝐢𝐒𝐀 𝐌𝐔𝐇 𝐁𝐀𝐍𝐀 𝐋𝐢𝐘𝐀😻😄", threadID);
     };
     if ((event.body.toLowerCase() == "💕") || (event.body.toLowerCase() == "💞")) {
    ...
    if ((event.body.toLowerCase() == ".und") || (event.body.toLowerCase() == ".unsand")) {
      ...
      if ((event.body.toLowerCase() == "🤗") || (event.body.toLowerCase() == "🤗")) {
       return api.sendMessage("😻🌿𝐘𝐀𝐇𝐀 𝐍𝐀𝐇𝐢 𝐢𝐁 𝐂𝐇𝐀𝐋𝐎💐☺️", threadID);
     };
   ...
   if ((event.body.toLowerCase() == "🙏") || (event.body.toLowerCase() == "🙏🙏")) {
    ...
    if ((event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thanks")) {
       return api.sendMessage("😻🌿𝐁𝐀𝐒 𝐁𝐀𝐒 𝐊𝐈𝐓𝐍𝐀 𝐓𝐀𝐑𝐄𝐄𝐅 𝐊𝐀𝐑𝐎𝐆𝐄🤭🤭😁", threadID);
     };
  ...
  ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "good morning")) {
    ...
    if ((event.body.toLowerCase() == "by") || (event.body.toLowerCase() == "bye")) {;
     ...
     if ((event.body.toLowerCase() == "chup") || (event.body.toLowerCase() == "stop") || (event.body.toLowerCase() == "chup ho ja") || (event.body.toLowerCase() == "chup kar")) {
       return api.sendMessage("𝐍𝐀𝐇𝐈 𝐑𝐀𝐇𝐔𝐍𝐆𝐢 𝐂𝐡𝐮𝐩 𝐓𝐇𝐀𝐑𝐊𝐢 😼 𝐌𝐔𝐉𝐇𝐄 𝐁𝐎𝐋𝐍𝐀 𝐇𝐄.𝐌𝐄𝐑𝐀 𝐉𝐔𝐁𝐀𝐍. 𝐌 𝐁𝐎𝐋𝐔𝐍𝐆𝐢 𝐒𝐀𝐌𝐄𝐄𝐑 𝐊𝐎 𝐁𝐀𝐓𝐀𝐔 𝐊𝐈𝐘𝐀 🌿🙄🙄", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "☺️")) {return api.sendMessage("W𝐀𝐇 𝐊𝐢𝐘A M𝐔𝐒𝐊𝐔𝐑𝐀𝐇𝐀𝐓 𝐇E 𝐀𝐏𝐊𝐢 🤭🤣", threadID);
     };
